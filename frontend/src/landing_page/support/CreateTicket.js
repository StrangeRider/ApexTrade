...
function CreateTicket() {
    return ( 
        <div className='container'>
            <h1 className='fs-2 mt-5 p-5'>To create a ticket, select a relevant topic</h1>

            <div className='row  mb-5'>
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="mb-4"><i class="fa fa-plus-circle fa-sm" aria-hidden="true"></i> Account Opening</h4>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="mb-4"><i class="fa-solid fa-circle-user fa-sm"></i> Your Zerodha Account</h4>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="mb-4"><i class="fa-solid fa-chart-simple fa-sm"></i> Your Zerodha Account</h4>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="mb-4"><i class="fa-solid fa-credit-card fa-sm"></i> Funds</h4>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="mb-4"><i class="fa-solid fa-circle-notch fa-sm"></i> Console</h4>
                    ...
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Refferral Program</a><br />
                </div>

                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="mb-4"><i class="fa-regular fa-circle fa-sm"></i> Coin</h4>
